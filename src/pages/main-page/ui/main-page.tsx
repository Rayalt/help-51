...
import { ButtonLink, SwiperNavigations, SwiperSlider } from 'shared/ui';
...
import { navbarAbout } from 'shared/config/navbar';
	...
	return (
		...
		>
			<SectionCols
				...
				bgPos1={{ 
					xs: 'right -247px bottom -48px', 
					sm: 'right -140px bottom -188px', 
					md: 'right -210px bottom -288px', 
					lg: 'right -210px bottom -388px' 
				}}
				bgImage2='starsSmall'
			...
			<Section
				...
				bgPos1={{ 
					xs: 'right -336px bottom -46px', 
					sm: 'right -464px bottom -66px', 
					md: 'right -662px bottom -93px', 
					lg: 'right -810px bottom -126px' 
				}}
				bgImage2='starsLargeBW'
				bgSize2={{ xs: '500px', sm: '600px', md: '700px', lg: '866px' }}
