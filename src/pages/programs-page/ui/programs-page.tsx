...
import classes from '../programs-page.module.scss';
...
const ProgramsPage = () => {
	return (
		<Section
			...
			bgPos1={{ xs: "right -336px bottom -156px", sm: "right -464px bottom -272px", md: "right -662px bottom -496px", lg: 'right -810px bottom -640px' }}
